...
const CopySVG = () => {
  return (
    <svg
      ...
      />
      <path
        d="M4.012 17.237C3.705 17.0626 3.44965 16.81 3.2719 16.5049C3.09415 16.1998 3.00034 15.8531 3 15.5V5.5C3 4.4 3.9 3.5 5 3.5H15C15.75 3.5 16.158 3.885 16.5 4.5"
        stroke="var(--mainColor1)"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
