...
import DeletePermissionFromRoleModal from '../modals/delete-permission-from-role';
import EditSVG from '@app/_components/svgs/modals/edit';

const PermissionItem = ({ item, role }) => {
      ...
      <td>
        <div className="flex items-center gap-[10px] justify-end">
          <div className="relative">
            ...
            <DeletePermissionFromRoleModal
              id={`${role.id}${item.id}${item.type}`}
            />
